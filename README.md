...
- [supabase/pg_crdt](https://github.com/supabase/pg_crdt) - CRDT support in Postgres (experimental)
...
- [nmrugg/stockfish.js](https://github.com/nmrugg/stockfish.js) - The Stockfish chess engine for web browsers
...
- [chiuhans111/fluidglass](https://github.com/chiuhans111/fluidglass) - An interactive liquid glass experience.
...
- [wh0/nix-cache-view](https://github.com/wh0/nix-cache-view) - in-browser .nar explorer
...
- [breck7/scrollsdk](https://github.com/breck7/scrollsdk) - The code for Particles and Parsers, which Scroll is built on.
...
- [NitorCreations/nix-mdatp](https://github.com/NitorCreations/nix-mdatp) - 
...
- [sp-tarkov/build](https://github.com/sp-tarkov/build) - 
...
- [vladstudio/tiniri-wezterm](https://github.com/vladstudio/tiniri-wezterm) - 
...
- [davidbrochart/tdiff](https://github.com/davidbrochart/tdiff) - Textual diff application
...
- [imtt-dev/steer](https://github.com/imtt-dev/steer) - The Active Reliability Layer for AI Agents. Catch failures, teach fixes, and automate reliability
...
- [iamtelescope/telescope](https://github.com/iamtelescope/telescope) - Web-based log viewer UI. Explore logs data stored in several sources: ClickHouse, Kubernetes or Docker
...
- [armijnhemel/binaryanalysis-ng](https://github.com/armijnhemel/binaryanalysis-ng) - Binary Analysis Next Generation (BANG)
...
- [fgmacedo/python-statemachine](https://github.com/fgmacedo/python-statemachine) - Expressive statecharts and FSMs for modern Python.
...
- [spinframework/spin-python-sdk](https://github.com/spinframework/spin-python-sdk) - Spin SDK for Python
...
- [dusty-phillips/match-variant](https://github.com/dusty-phillips/match-variant) - Python variant types that work with match
...
- [CycloneDX/cyclonedx-python-lib](https://github.com/CycloneDX/cyclonedx-python-lib) - Functionality and DataModels of OWASP CycloneDX for Python
...
- [mathiasertl/django-ca](https://github.com/mathiasertl/django-ca) - A TLS certificate authority with CRL, OCSP, HSM and ACMEv2 support and more.
...
- [graphql-python/graphql-core](https://github.com/graphql-python/graphql-core) - A Python 3 port of the GraphQL.js reference implementation of GraphQL.
...
- [python-hyper/hpack](https://github.com/python-hyper/hpack) - Pure-Python HTTP/2 header encoding
...
- [gogcom/galaxy-integrations-python-api](https://github.com/gogcom/galaxy-integrations-python-api) - NOTE: Please report here only issues related to the python API. Issues and general feedback regarding the GALAXY Client shall be sent via GALAXY Client menu
...
- [360org/Projects](https://github.com/360org/Projects) - Odoo Projects
...
- [agx/git-buildpackage](https://github.com/agx/git-buildpackage) - Mirror of https://salsa.debian.org/agx/git-buildpackage
...
- [redmine-gitlab-migrator/redmine-gitlab-migrator](https://github.com/redmine-gitlab-migrator/redmine-gitlab-migrator) - Migrate code projects from Redmine to Gitlab, keeping issues/milestones/metadata
...
- [wbond/tls.wbond.net](https://github.com/wbond/tls.wbond.net) - Keys, certificates, scripts and configuration for tls.wbond.net
...
- [openedx/openedx-platform](https://github.com/openedx/openedx-platform) - The Open edX LMS & Studio, powering education sites around the world!
...
- [pallets-eco/flask-social](https://github.com/pallets-eco/flask-social) - OAuth Provider Integration for Flask-Security
...
- [russellromney/turbolite](https://github.com/russellromney/turbolite) - SQLite VFS with sub-100ms cold JOIN queries from S3 + page-level compression and encryption
...
- [orhun/cargo-nocode](https://github.com/orhun/cargo-nocode) - Cargo subcommand to easily bootstrap nocode applications. Write nothing; deploy nowhere.
...
- [xnuter/http-tunnel](https://github.com/xnuter/http-tunnel) - HTTP(S), QUIC Tunnel and TCP Proxy
...
- [jpeddicord/askalono](https://github.com/jpeddicord/askalono) - this project is no longer being maintained. forks are welcome under the original license terms.
...
- [OCA/ansible-odoo](https://github.com/OCA/ansible-odoo) - [NOT MAINTAINED] Ansible role for Odoo
...
- [microsoft/TypeAgent](https://github.com/microsoft/TypeAgent) - Sample code that explores an architecture for using language models to build a personal agent that can work with application agents.
...
- [juanbzz/next-csrf](https://github.com/juanbzz/next-csrf) - CSRF mitigation for Next.js
